...
function DashboardView({ children }) {
  ...
  return (
    <>
      ...
      <div className={`${offcanvas ? "offcanvas-backdrop-show" : ""}  `}></div>
      <div className={`offcanvas offcanvas-end ${offcanvas ? "show" : ""}`} >
        <div className="offcanvas-header " >
          ...
          <div className="">
            <button
              className={` text-gray-400 hover:text-gray-600 ${offcanvas  ? "" : ""}`}
            >
              <Cancelicon></Cancelicon>
            </button>
          </div>
