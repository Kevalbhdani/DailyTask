...
function DashboardView({ children }) {
  ...
  return (
    <>
          ...
          <header className=" header  shadow-md space-x-4  sticky top-0 right-0 px-4 p-4 w-full  bg-white z-[9] ">
            <div className="flex items-center w-full relative  ">
              ...
              <div className="flex items-center ms-auto  ">
                ...
                <button onClick={offcanvasprofile}>
                  {/* onClick={openModal profileOffcanvas} */}
      ...
      <div className={`   ${offcanvas ? "offcanvas-backdrop-show" : "remove"
        }`}></div>
      {/* {
        isOpen && ( */}
      <div className={`  ${offcanvas ? "offcanvasshow" : ""
        }`}>
        <div className="offcanvas justify-between flex-col items-center bg-white  rounded-l-3xl shadow-lg w-[450px] relative overflow-auto xl:overflow-y-hidden z-[999] " onClick={(e) => e.stopPropagation()}>
          <div
            className="offcanvas-header lg:p-6 md:p-4 sm:p-3 p-3 justify-between flex items-center sticky top-0 right-0 z-10 bg-white" >
            <div className="title-section">
              <h2 className="text-2xl font-bold  font-nunitoSans text-start">
                Edit Profile
              </h2>
          ...
          <div className="offcanvas-body h-full lg:p-5 md:p-4 sm:p-3 p-3 mb-5 text-startcflex flex-col content-between">
            <form action="">
              <div className="upload-img relative ">
                <div className=" mx-auto img-preview w-[100px] h-[100px] p-2">
                  <img
              ...
              <div className="mb-4">
                ...
                <div className=" relative mt-2  ">
                  <input
                    type="text"
                    placeholder=" EnterFull Name"
                    className="w-full px-14 py-3 bg-whiteLight rounded-xl text-sm "
                  />
                  <img
                    className="size-[20px] top-3 left-5 absolute"
                    src={require("../../imges/hospital.png")}
                    alt=""
                  />
                </div>
          ...
          <div className="offcanvas-footer pb-4 px-3 lg:px-5 md:px-4 sm:px-3 right-0 bottom-0 sticky bg-white ">
            <button className="bg-blue-500 text-white w-full rounded-lg transition duration-300 py-3.5">
              Save
            </button>
          </div>
